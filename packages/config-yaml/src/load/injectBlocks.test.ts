...
schema: v1
rules:
  - "Input: \${{ inputs.userSetting }} | Secret: \${{ secrets.apiKey }} | Continue: \${{ ocircuit.workspaceRoot }}"
`;
    ...
    expect(ruleText).toBe(
      "Input: ${{ secrets.//userSetting }} | Secret: ${{ secrets.//apiKey }} | Continue: ${{ ocircuit.workspaceRoot }}",
    );
    ...
    expect(configStr).toContain("ocircuit.workspaceRoot");
  });
