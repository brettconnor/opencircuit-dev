...
```bash
oc --readonly "Help me analyze this code"  # Starts in plan mode
oc --auto "Fix all the linting errors"     # Starts in auto mode
oc "Let me implement this feature"         # Starts in normal mode (default)
```
