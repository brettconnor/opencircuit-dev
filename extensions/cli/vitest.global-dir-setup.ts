...
// `core/util/paths.ts`, because that module resolves `OCIRCUIT_GLOBAL_DIR`
...
const globalDir = fs.mkdtempSync(path.join(os.tmpdir(), "ocircuit-cli-test-"));
process.env.OCIRCUIT_GLOBAL_DIR = globalDir;
