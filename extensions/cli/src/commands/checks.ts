...
/**
 * Main entry point for `oc checks` command.
 *
 * Usage:
 *   oc checks [pr-url]              - List checks with diffs
 *   oc checks accept [pr-url]       - Accept pending suggestions
 *   oc checks reject [pr-url]       - Reject pending suggestions
 */
