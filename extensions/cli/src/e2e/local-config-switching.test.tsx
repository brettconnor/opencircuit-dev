  ...
  test("understands local vs remote config paths", () => {
    ...
    const configTypes = {
      ...
      remoteAssistantSlugs: [
        "opencircuit-dev/default-cli-config",
    ...
    const problemScenarios = [
      {
        ...
        from: "opencircuit-dev/default-cli-config",
