...
vi.mock("./env.js", () => ({
  env: {
    ocircuitHome: "/home/test/.ocircuit",
  },
}));
...
vi.mock("./session.js", () => ({
  getSessionFilePath: vi.fn(
    () => "/home/test/.ocircuit/cli-sessions/ocircuit-cli-pid-12345.json",
  ),
  ...
  describe("handleSlashCommands", () => {
    ...
    it("should use test session directory when in test mode", async () => {
      ...
      (getSessionFilePath as any).mockReturnValue(
        "/test-home/.ocircuit/cli-sessions/ocircuit-cli-test-123.json",
      );
      ...
      expect(result?.output).toContain("/test-home/.ocircuit/cli-sessions/");
