---
title: "Replicate"
description: "Configure Replicate with Open Circuit to access newly released language models or deploy your own through their platform, with support for various models including CodeLLama"
---
...
[View the source](https://github.com/open-circuit-dev/open-circuit/blob/main/core/llm/llms/Replicate.ts)
