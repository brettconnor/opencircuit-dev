---
title: "Tensorix"
description: "Configure Tensorix with Open Circuit to access DeepSeek, Llama, Qwen, GLM, and other models through a single OpenAI-compatible API gateway"
---
...
[View the source](https://github.com/open-circuit-dev/open-circuit/blob/main/core/llm/llms/Tensorix.ts)
