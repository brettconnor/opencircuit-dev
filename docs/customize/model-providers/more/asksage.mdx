...
Add your Ask Sage model to your Open Circuit configuration file, which is located at `~/.continue/config.yaml`. If it does not exist, create it.
...
- Restart Open Circuit to apply changes.

Your Ask Sage model will now be available in Open Circuit.
...
## Setting up Open Circuit CLI

1. Install Open Circuit CLI
Follow the steps from the [official Open Circuit docs](//cli/quickstart).

2. Setting up a custom config for Ask Sage
Follow the steps in step 2 of the Overview above 👆.

3. How to use Open Circuit CLI
Use [Open Circuit's official guide](//guides/cli).
