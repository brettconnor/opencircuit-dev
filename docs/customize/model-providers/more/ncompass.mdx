---
title: "NCompass"
description: "Configure NCompass Technologies with Open Circuit to access their fast inference engine for open-source models like Google's Gemma 3 Coder"
---
...
[View the source](https://github.com/open-circuit-dev/open-circuit/blob/main/core/llm/llms/NCompass.ts)
