---
title: "Relace"
description: "Configure Relace with Open Circuit to access their Fast Apply model, which helps you quickly and reliably apply chat suggestions to your codebase"
---
...
[View the source](https://github.com/open-circuit-dev/open-circuit/blob/main/core/llm/llms/Relace.ts)
