...
description: "Open Circuit supports a wide range of AI model providers to power different features like chat, code editing, autocompletion, and embeddings. This overview helps you navigate through the available options and find the right provider for your needs."
---
...
Beyond the top-level providers, Open Circuit supports many other options:
