---
title: "How to Configure OpenRouter with Open Circuit"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover OpenRouter models [here](//openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](//openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  Open Circuit automatically uses system message tools for models that don't support
