---
title: "How to Configure Ollama with Open Circuit"
slug: ../ollama
sidebarTitle: "Ollama"
---

<Tip>
  **Discover Ollama models [here](//lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](//ollama/qwen3-coder-30b?view=config)**
</Info>
...
Open Circuit may set a higher default context length than other Ollama tools, causing this error even when the model works elsewhere. Fix by reducing `contextLength`:
