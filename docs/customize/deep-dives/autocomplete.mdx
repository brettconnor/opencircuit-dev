---
title: "Open Circuit Autocomplete Setup and Configuration Guide"
description: "Step-by-step guide to setting up and configuring autocomplete in Open Circuit, including Codestral, Ollama, and IDE settings."
...
## How to Set Up Autocomplete in Open Circuit with Codestral (Recommended)
...
## How to Set Up Autocomplete in Open Circuit with Ollama (Local Model)
...
## Autocomplete Configuration Options in Open Circuit

### Customize Autocomplete User Settings in the Open Circuit Extension
...
7. If you are still having issues, please file an issue on [GitHub](https://github.com/open-circuit-dev/open-circuit/issues).
...
### How to Turn Off Autocomplete in Open Circuit (VS Code and JetBrains)

#### VS Code

Click the "Open Circuit" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "Open Circuit" and uncheck the box for "Enable Tab Autocomplete".
...
Open Settings -> Tools -> Open Circuit and uncheck the box for "Enable Tab Autocomplete".

#### Feedback

If you're turning off autocomplete, we'd love to hear how we can improve! Please file an issue on [GitHub](https://github.com/open-circuit-dev/open-circuit/issues).
