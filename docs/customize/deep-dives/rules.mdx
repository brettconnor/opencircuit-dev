---
title: "How to Create and Manage Rules in Open Circuit"
...
## How Rules Work in Open Circuit
...
globs: docs/**/*.{md,mdx}
alwaysApply: false
description: Standards for writing and maintaining Open Circuit Docs
---

# Open Circuit Docs Standards
...
Open Circuit includes a simple default system message for [Agent mode](../../ide-extensions/agent/quick-start) and [Chat](../../ide-extensions/chat/quick-start) requests, to help the model provide reliable codeblock formats in its output.

This can be viewed in the rules section of the toolbar (see above), or in the source code [here](https://github.com/open-circuit-dev/open-circuit/blob/main/core/llm/constructMessages.ts#L4).
