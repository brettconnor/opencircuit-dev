---
title: "Next Edit"
description: "Learn how Open Circuit's Next Edit feature predicts and suggests your next code changes using AI, going beyond traditional autocomplete to anticipate entire code modifications"
---

<Warning>
  Next Edit is currently an experimental feature. It requires
  [Instinct](//open-circuit-dev/instinct) or [Mercury Coder
  model](//inception/mercury-coder) configured in
  your Open Circuit autocomplete settings and is not yet available for JetBrains
  use.
</Warning>
...
<Note>
  ...
  in your Open Circuit autocomplete model settings. This model is specifically
...
<Step title="Accept or Reject">
  ...
  <Step title="Open Circuit Coding">
...
- **Instinct**: The leading open Next Edit model, trained by Open Circuit

### Automatic Detection

Open Circuit automatically enables Next Edit when:
...
<Card title="Provide Feedback" icon="message">
  Have feedback? We want to hear it. __[File an issue on GitHub](https://github.com/open-circuit-dev/open-circuit/issues)__
  to help us improve.
</Card>

  <Card title="Combine with Other Features" icon="puzzle-piece">
    Use Next Edit alongside Open Circuit's Chat and Agent modes for comprehensive AI-assisted development.
  </Card>
</CardGroup>

---

_Next Edit represents Open Circuit's vision for proactive AI coding assistance that anticipates developer needs rather than just reacting to input. As this feature evolves, it will become a powerful tool for accelerating development workflows and reducing repetitive coding tasks._
