---
title: "How Autocomplete Works in Open Circuit"
sidebarTitle: "How Autocomplete Works"
description: "Understand how Open Circuit's autocomplete works, including timing optimization, context retrieval from your codebase, and filtering to improve AI code suggestions."
---
...
Open Circuit uses a number of retrieval methods to find relevant snippets from your codebase to include in the prompt.
