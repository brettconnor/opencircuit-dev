---
title: "Recommended Models for Autocomplete in Open Circuit"
description: "Choose the best autocomplete model for Open Circuit, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, Open Circuit supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
