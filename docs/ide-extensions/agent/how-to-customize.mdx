...
description: "Learn how to customize Agent Mode in Open Circuit to better fit your workflow and coding style."
...
- **Ask First (default)**: Request user permission with "Cancel" and "Open Circuit" buttons
