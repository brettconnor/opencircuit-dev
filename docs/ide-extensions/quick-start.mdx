...
description: "Learn Open Circuit's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to Open Circuit! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Open Circuit's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Open Circuit](/ide-extensions/install) and [signed
  in](https://auth.docs.open-circuit.dev/) to get started.
</Info>
...
Press **Enter** and watch Open Circuit suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
Open Circuit will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch Open Circuit refactor your code automatically!
</Step>

<Step title="Review Changes">
Open Circuit will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
**Cmd/Ctrl + L**  
New Chat / New Chat With Selected Code / Close Open Circuit Sidebar If Chat Already In Focus

**Cmd/Ctrl + Shift + L**  
Focus Current Chat / Add Selected Code To Current Chat / Close Open Circuit Sidebar If Chat Already In Focus
...
Ready to explore more? Open Circuit offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core Open Circuit features. Here's what to explore next:
