---
title: "Recommended Models for Chat in Open Circuit"
description: "Choose the best chat model for Open Circuit, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
