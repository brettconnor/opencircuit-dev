...
2. **Core initialization**
   - Given the minimal configuration and test doubles, Core initializes without loading editor-specific modules.
...
- Validation command proving the decision.
