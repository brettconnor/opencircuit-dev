export const ModelRecommendations = ({ role = "all" }) => {
  ...
  const modelRecs = {
    agent_plan: {
      open: [
        "[Qwen3 Coder (480B)](//openrouter/qwen3-coder)",
        "[Qwen3 Coder (30B)](//ollama/qwen3-coder-30b)",
        "[Devstral (27B)](//ollama/devstral)",
        "[Kimi K2 (1T)](//openrouter/kimi-k2)",
        "[gpt-oss (120B)](//openrouter/gpt-oss-120b)",
        "[gpt-oss (20B)](//ollama/gpt-oss-20b)",
        "[GLM 4.5 (355B)](//openrouter/glm-4-5)",
        "[GLM 4.5 Air (106B)](//openrouter/glm-4-5-air)",
      ],
      closed: [
    ...
    autocomplete: {
      open: [
        "[QwenCoder2.5 (1.5B)](//ollama/qwen2.5-coder-1.5b)",
        "[QwenCoder2.5 (7B)](//ollama/qwen2.5-coder-7b)",
      ],
      closed: [
    ...
    apply: {
      open: ["[FastApply](//mdpauley/fast-apply-15b-v10)"],
      closed: [
        "[Relace Instant Apply](//relace/instant-apply)",
        "[Morph Fast Apply](//morphllm/morph-v2)",
      ],
    ...
    embed: {
      ...
      closed: [
        ...
        "[Morph Embeddings](//morphllm/morph-embedding-v2)",
        "Codestral Embed",
      ],
      notes: "Closed models are slightly better than open models",
    },
    rerank: {
      ...
      closed: [
        ...
        "Relace Code Rerank",
        "[Morph Rerank](//morphllm/morph-rerank-v2)",
      ],
      notes: "Open models are beginning to emerge for this model role",
    },
    next_edit: {
      open: ["[Instinct](//open-circuit-dev/instinct)"],
      closed: ["[Mercury Coder](//inception/mercury-coder)"],
      notes: "Closed models are better than open models",
    },
  };
