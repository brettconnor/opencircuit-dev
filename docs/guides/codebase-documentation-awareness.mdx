...
[DeepWiki MCP](//deepwiki/deepwiki-mcp) lets agent mode explore any public GitHub repository.
...
[Context7 MCP](//upstash/context7-mcp) enables agent mode to search and retrieve information from public documentation:
...
The new approach provides better integration with Open Circuit's Agent mode features and more intelligent context selection.
