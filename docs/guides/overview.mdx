---
title: "How to Use Open Circuit Guides"
description: "Comprehensive collection of practical guides for Open Circuit including model setup, local development with Ollama, offline usage, self-hosting, custom context providers, and advanced customization tutorials"
---

## What Model & Setup Guides Are Available

- [Using Ollama with Open Circuit](/guides/ollama-guide) - Local AI development with Ollama
- [How to Self-Host a Model](/guides/how-to-self-host-a-model) - Self-hosting AI models
- [Running Open Circuit Without Internet](/guides/running-continue-without-internet) - Offline development setup

## CLI & Automation

- [How to Use Open Circuit CLI (cn)](/guides/cli) - Command-line interface for Open Circuit
- [Pull Request Review Bot with GitHub Actions](/guides/github-pr-review-bot) - Set up automated, privacy-first code reviews using Open Circuit CLI

## MCP Integration Cookbooks

Step-by-step guides for integrating Model Context Protocol (MCP) servers with Open Circuit:

<CardGroup cols={3}>

  <Card title="Open Circuit Docs MCP Cookbook" icon="book" href="/guides/continue-docs-mcp-cookbook">
    Use the Open Circuit Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows
  </Card>
...
Have a guide idea or found an issue? We welcome contributions! Check our [GitHub repository](https://github.com/open-circuit-dev/open-circuit) to get involved.
