...
description: "Learn how to deploy and self-host open-source language models using HuggingFace TGI, vLLM, SkyPilot, Anyscale Private Endpoints, or Lambda for use with Open Circuit"
---

- [HuggingFace TGI](https://github.com/open-circuit-dev/open-circuit#tgi)
- [vLLM](https://github.com/open-circuit-dev/open-circuit#vllm)
- [SkyPilot](https://github.com/open-circuit-dev/open-circuit#skypilot)
- [Anyscale Private Endpoints](https://github.com/open-circuit-dev/open-circuit#anyscale-private-endpoints) (OpenAI compatible API)
- [Lambda](https://github.com/open-circuit-dev/open-circuit#lambda)

## How to Self-Host an Open-Source Model

For many cases, either Open Circuit will have a built-in provider or the API you use will be OpenAI-compatible, in which case you can use the "openai" provider and change the "baseUrl" to point to the server.
