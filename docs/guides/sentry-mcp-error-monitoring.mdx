...
<Card title="What You'll Build" icon="bug">
  An automated error monitoring system that uses Open Circuit CLI with Sentry MCP to analyze production errors, identify root causes with AI, and create detailed GitHub issues with suggested fixes.
</Card>
...
- [Open Circuit CLI](//guides/cli) with **active credits** (required for API usage)
...
<Steps>
  ...
  <Step title="Set up Open Circuit CLI Account & API Key">
    1. Visit [Open Circuit Organizations](//settings/organizations)
    2. Sign up or log in to your Open Circuit account
...
<Tip>
  Open Circuit CLI handles complex error analysis and API interactions - you just need to provide the right prompts!
</Tip>
...
<Tabs>
  <Tab title="Configure Sentry MCP">
    ...
    The Sentry MCP supports multiple configuration methods. For Open Circuit CLI, OAuth is recommended:
  ...
  <Tab title="Sentry API Credentials">
    ...
    3. Name it "Open Circuit CLI Error Analysis"
...
<Steps>
  <Step title="Add Sentry MCP to Open Circuit CLI">
  ...
  <Step title="Create Custom Error Analysis Prompts">
    Use this prompt template with Open Circuit CLI to analyze Sentry errors:
...
Use Open Circuit CLI to perform intelligent error analysis. Enter these prompts in the Open Circuit CLI TUI:
...
Create actionable GitHub issues from Sentry errors. Enter this prompt in the Open Circuit CLI TUI:
...
Automate error monitoring with the [Sentry Release GitHub Action](https://docs.sentry.io/product/releases/setup/release-automation/github-actions/) and Open Circuit CLI to create comprehensive, AI-powered issue descriptions:

<Tip>
  **Why Combine Sentry Releases with Open Circuit CLI?**
  - **Release Tracking**: Associate errors with specific deployments
  - **AI-Powered Analysis**: Open Circuit CLI generates detailed issue descriptions with root cause analysis
    ...
    steps:
      ...
      - name: Analyze Sentry Errors and Create Issues
        ...
        run: |
          ...
          # Use Open Circuit CLI to analyze errors and generate comprehensive issue descriptions
...
<Info>
  **Workflow Best Practices**:
  ...
  - Use Open Circuit CLI to generate comprehensive, AI-powered issue descriptions
...
<Card title="Continuous AI Error Monitoring" icon="shield-check">
  Your system now operates at **[Level 2 Continuous AI](https://blog.docs.open-circuit.dev/what-is-continuous-ai-a-developers-guide/)** - AI handles routine error analysis with human oversight through GitHub issue review and resolution.
</Card>

## Advanced Error Analysis Prompts

Enhance your workflow with these advanced Open Circuit CLI prompts:
...
<Warning>
  **Protect Your API Keys**:
  ...
  - Use Open Circuit CLI's secure secret storage
...
| OAuth prompt not appearing | Check that Open Circuit CLI has proper MCP configuration |
...
- [Open Circuit CLI Guide](//guides/cli)
- [Continuous AI Best Practices](https://blog.docs.open-circuit.dev/what-is-continuous-ai-a-developers-guide/)
