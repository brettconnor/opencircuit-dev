...
description: "Learn how to work with Open Circuit's configuration system. Understand how to use models, rules, and tools, create local configurations, and organize your setup for maximum reusability."
---

## What Are Models, Rules, and Tools?

Open Circuit configs are built from three main types of configuration:
...
Open Circuit uses a slug in the format of `owner/item-name` to resolve blocks.
