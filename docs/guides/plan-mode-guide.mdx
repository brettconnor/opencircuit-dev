---
title: "Using Plan Mode with Open Circuit"
...
Context is the foundation of effective planning. Without proper context, AI models fall back on generic patterns, leading to plans that don't fit your specific system. Open Circuit's [context system](/ide-extensions/chat/context-selection) transforms broad suggestions into actionable strategies:
