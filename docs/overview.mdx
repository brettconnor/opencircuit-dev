...
<CodeGroup>
    ...
    ```bash yarn
    yarn global add @open-circuit-dev/open-circuit-cli
    ```

    ```bash pnpm
    pnpm add -g @open-circuit-dev/open-circuit-cli
    ```
...
Learn more about [extension features](//ide-extensions/quick-start) and how to [customize](//customize/overview) →
...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="https://github.com/open-circuit-dev/open-circuit"
  >
