...
| `media`                         | Defer (confirmed); root README banner removed | The root README was a non-production landing page; retained product documentation still owns its own media references | Root `README.md` and `media/github-readme.png` were removed together; `extensions/intellij/CONTRIBUTING.md` and `extensions/vscode/README.md` retain their own product-specific media references | Directory retained for remaining product/documentation references; root README cleanup had no retained-closure impact |
