...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .ocircuitignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".ocircuitignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .ocircuitignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".ocircuitignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.ocircuitignore", "level3/"],
    ]);
    const result = await shouldIgnore(
