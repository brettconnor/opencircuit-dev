...
export type ToWebviewFromIdeProtocol = ToWebviewFromIdeOrCoreProtocol & {
  ...
  focusOCircuitInput: [undefined, void];
  focusOCircuitInputWithoutClear: [undefined, void];
  focusOCircuitInputWithNewSession: [undefined, void];
  ...
  focusOCircuitSessionId: [{ sessionId: string | undefined }, void];
