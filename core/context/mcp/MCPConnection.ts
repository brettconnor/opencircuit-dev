...
For personal use you can set the secret in the hub at //settings/secrets.
Org-level secrets can only be used for MCP by Background Agents (//hub/agents/overview) when \"Include in Env\" is enabled.`,
      );
    }
