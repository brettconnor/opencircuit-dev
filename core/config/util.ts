 ...
 *
 * See here for details: https://github.com/open-circuit-dev/open-circuit/issues/940
 */
...
async function showUnsupportedCpuToast(ide: IDE) {
  ...
  if (shouldOpenLink) {
    void ide.openUrl(
      "//troubleshooting#i-received-a-codebase-indexing-disabled---your-linux-system-lacks-required-cpu-features-avx2-fma-notification",
    );
  }
}
